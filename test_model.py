...
model = models.load_model("network_config_1/500_epoch_3000_sample/model.hdf5")

# model = models.load_model("./network_config_2/500_epoch_3000_samples/model.hdf5")

# model = models.load_model("./network_config_3/1000_epoch_3000_samples/model.hdf5")
...
for j in range(tests):
    ...
    # generate data
    E_actual, t, w, dt, w0, frogtrace_flat = retrieve_data(plot_frog_bool=False, print_size=False)
